...
void auton_skills(){
  ...
  chassis.pid_odom_set({{41.546, 45.838}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
  chassis.pid_turn_set({61.1,45.638}, fwd, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_odom_set({{61.1, 45.638}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
  pros::delay(1200);
