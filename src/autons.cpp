...
void right_fast_wing_auton(){
  ...
  chassis.pid_odom_set({{-24.046, -47.965}, rev, DRIVE_SPEED}, true);
  // tongue.set(0);
...
void right_bottom_auton(){
  ...
  chassis.pid_turn_set({-6.494_in, -8.119_in}, fwd, TURN_SPEED);
  chassis.pid_wait();
  tongue.set(0);
  pros::delay(50);
  intake.move(-80);
  ...
  chassis.pid_odom_set({
                        {{-41.64_in, -42.965_in}, rev, DRIVE_SPEED},
                       },
                       true);
  chassis.pid_wait();
  tongue.set(1);
  ...
  chassis.pid_turn_set({-56.194_in, -42.965_in}, fwd, TURN_SPEED);
  chassis.pid_wait();

  chassis.pid_odom_set({{-56.194_in, -42.965_in}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
  pros::delay(500);

  chassis.pid_odom_set({{-26.546, -42.965}, rev, DRIVE_SPEED}, true);
  chassis.pid_wait();
  slopeScore();
  pros::delay(1700);
  intake_in();

  chassis.pid_odom_set({{-39.546_in, -33.965_in}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();

  chassis.pid_odom_set({{{-30.546_in, -33.465_in}, rev, BACK_DRIVE_SPEED},
                        {{-8.546_in, -33.465_in}, rev, BACK_DRIVE_SPEED},
                       },
                       true);
  chassis.pid_wait();
}
...
void auton_skills(){
  ...
  chassis.pid_wait();
  chassis.pid_odom_set({{-58.1, -47.638}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
  pros::delay(1500);
  ...
  chassis.pid_odom_set({{26.417, -48.838}, rev, BACK_DRIVE_SPEED}, true);
  chassis.pid_wait();
  intake_out();
  pros::delay(100);
  slopeScore();
  ...
  chassis.pid_odom_set({{41.546, 49.838}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
  chassis.pid_turn_set({61.1,49.638}, fwd, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_odom_set({{61.1, 49.638}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
  pros::delay(1500);
  ...
  chassis.pid_turn_set({-57.1,45.638}, fwd, TURN_SPEED);
  chassis.pid_wait();
  tongue.set(1);

  chassis.pid_odom_set({{-24.417, 45.838}, rev, BACK_DRIVE_SPEED}, true);
  chassis.pid_wait();
  slopeScore();
  pros::delay(1950);
  intake_in();
  chassis.pid_odom_set({{-57.1, 45.638}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
  pros::delay(1500);
  ...
  chassis.pid_odom_set({{-66, 0}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
