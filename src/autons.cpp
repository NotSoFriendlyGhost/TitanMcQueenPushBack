...
void fast_wing_auton(){
  ...
  chassis.pid_odom_set({{-45.546_in, 58.965_in}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
...
void right_fast_wing_auton(){
  ...
  chassis.pid_odom_set({{-25.546, -47.965}, rev, DRIVE_SPEED}, true);
  // tongue.set(0);
...
void auton_skills(){
  ...
  chassis.pid_odom_set({{-41.417, -49.838}, fwd, DRIVE_SPEED}, true);
  chassis.pid_wait();
  descore.set(1);
...
void middle_auton(){
  ...
  chassis.pid_turn_set({-4.494_in, 8.119_in}, rev, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_odom_set({{-4.494, 8.119}, rev, DRIVE_SPEED}, true);
  chassis.pid_wait();
  middleScore();
  pros::delay(750);
  intake_in();
